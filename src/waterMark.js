...
function watermark(settings) {
            ...
            //获取页面最大高度
            var page_height = Math.max(document.body.scrollHeight,document.body.clientHeight)-60;
            ...
            for (var i = 0; i < defaultSettings.watermark_rows; i++) {
                ...
                for (var j = 0; j < defaultSettings.watermark_cols; j++) {
                    ...
                    mask_div.style.userSelect = "none";//住址选中文本发，防止复制
